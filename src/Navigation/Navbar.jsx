    ...
    >
      ...
      <div className="flex items-center gap-1 lg:gap-4">
        <label className="swap swap-rotate">
          ...
          />
          <svg
            className={`swap-off fill-current w-7 lg:w-10 h-5 lg:h-10 ${
              theme === "dark" ? "hidden" : ""
            }`}
          ...
          <svg
            className={`swap-on fill-current w-7 lg:w-10 h-5 lg:h-10 ${
              theme === "light" ? "hidden" : ""
            }`}
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
          ...
          {user?.photoURL ? (
            <>
              <button
                ...
                className="px-2 lg:px-3 py-1 h-10 lg:h-12 bg-btn_bg flex items-center gap-1 font-semibold text-sm lg:text-xl rounded"
              >
                <img
                  className="w-10 lg:w-14 rounded-full p-3"
                  onError={(e) => {
            ...
            <Link
              to={"/logIn"}
              className="px-2 lg:px-3 py-1 bg-btn_bg flex items-center gap-1 font-semibold text-sm lg:text-xl rounded"
            >
