...
const Services = () => {
  ...
  // Refetch for fetching services data
      ...
      <div className="flex items-center justify-center py-10">
        <div className="flex">
          <button
            ...
            } items-center px-4 font-semibold py-2 mx-1 hover:text-white bg-base-300 rounded-md cursor-pointer hover:bg-blue-600`}
          >
          ...
          <button
            ...
            } text-gray-700 transition-colors duration-300 transform bg-base-300 hover:bg-blue-600 hover:text-white rounded-md cursor-pointer`}
          >
            Next
