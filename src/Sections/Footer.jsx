    ...
    <div className="bg-base-100 rounded">
      <div className="p-4 lg:flex lg:justify-around lg:items-center sm:p-12">
        ...
        <div className="lg:text-center">
          <h1 className="text-2xl font-bold text-base-300">Irene Sims</h1>
          <p className="text-sm">VP of Sales, SomeCompany</p>
        </div>
        {/* Divider_Area */}
        <div className="w-16 h-1 my-4 bg-black rounded lg:w-1 lg:h-16"></div>
        <div>
          <div className="flex items-center py-1">
            <FiMail className="text-base-300" size={18} />
            <span className="px-4">irene.sims@example.com</span>
          </div>
          <div className="flex items-center py-1">
            <FiPhone className="text-base-300" size={18} />
            <span className="px-4">+123-456-7890</span>
          </div>
          <div className="flex items-center py-1">
            <FiLink className="text-base-300" size={18} />
            <span className="px-4">example.com</span>
          </div>
          <div className="flex items-center py-1">
            <FiMapPin className="text-base-300" size={18} />
