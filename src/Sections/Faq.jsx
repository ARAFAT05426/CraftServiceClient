                ...
                {isOpen === 0 && (
                  <>
                    ...
                    <p className="p-8 text-sm">
                      ...
                      friendly staff will assist you in scheduling a convenient
                      time for our expert team to visit your home.
                    </p>
                  </>
                )}
              </div>
                ...
                {isOpen === 2 && (
                  <>
                    ...
                    <p className="p-8 text-sm">
                      ...
                      guarantee. If you're not completely satisfied with the
                      quality of our workmanship, simply let us know and we'll
              ...
              <div className="rounded border-b">
                ...
                {isOpen === 3 && (
                  <>
                    ...
                    <p className="p-8 text-sm">
                      The duration of a repair job depends on various factors
                      such as the complexity of the issue and the availability
                      of materials. Our team will provide you with an estimated
                      timeframe for completion once we assess the scope of the
                      work involved.
                    </p>
                  </>
                )}
              ...
              <div className="rounded border-b">
                ...
                {isOpen === 4 && (
                  <>
                    ...
                    <p className="p-8 text-sm">
                      Yes, we understand that some repair issues require
                      immediate attention. That's why we offer emergency repair
                      services to address urgent situations such as burst pipes,
                      electrical faults, or other critical issues. Simply
                      contact us, and we'll dispatch our team to assist you as
                      soon as possible.
                    </p>
                  </>
                )}
